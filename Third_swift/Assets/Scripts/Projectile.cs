...
public class Projectile : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        rb.velocity = new Vector2(moveSpeed.x * transform.localScale.x, moveSpeed.y); //this projectile is kinematic
    }

    private void OnTriggerEnter2D(Collider2D collision)
    {
        Damageable damageable = collision.GetComponent<Damageable>();//make sure the target is damageable
